...
export default function InfoConfirmationPage({ data }) {
  ...
  const handleNext = async () => {
    ...
    try {
      ...
      setSnack({
        open: true,
        message: "Failed to save this step.",
        severity: "error",
      });
    }
  };
      ...
      case 0:
        return (
          <PersonalInfoStep
            ...
            onUpdate={(d) => updateFormData("personalInfo", d)}
            userEmail={userEmail}
            errors={formErrors}
          />
        );
      case 1:
        return (
          <BasicInfoStep
            ...
            onUpdate={(d) => updateFormData("basicInfo", d)}
            errors={formErrors}
          />
        );
      case 2:
        return (
          <SkillsStep
            ...
            onUpdate={(d) => updateFormData("skills", d)}
            errors={formErrors}
          />
        );
      case 3:
        return (
          <WorkExperienceStep
            ...
            onUpdate={(d) => updateFormData("workExperience", d)}
            errors={formErrors}
          />
        );
      case 4:
        return (
          <PortfolioStep
            ...
            onUpdate={(d) => updateFormData("portfolio", d)}
            errors={formErrors}
          />
        );
      case 5:
        return (
          <EducationStep
            ...
            onUpdate={(d) => updateFormData("education", d)}
            errors={formErrors}
          />
        );
      case 6:
        return (
          <JobPreferenceStep
            ...
            onUpdate={(d) => updateFormData("jobPreference", d)}
            errors={formErrors}
          />
        );
      default:
